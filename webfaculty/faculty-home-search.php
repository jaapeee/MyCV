	...
	<body>
		...
		<div class="mainbody">
			<form action="exec/faculty-home-execsearch.php" method="post">
				<fieldset><br>
					...
					<a href="faculty-home.php">Show All Students with Resume</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="profiles">
			...
			include("../set-db.php");
				...
				$studenttabquery=mysql_query("SELECT * FROM `personalinformation` WHERE firstname='$searched' or middlename='$searched' or lastname='$searched' or studentnumber='$searched' or emailaddress='$searched' and resumestatus='1'");
					while($studenttabres = mysql_fetch_array($studenttabquery)){
						$bookmark = $studenttabres['bookmark'];
						$resume= $studenttabres['resumestatus'];
						$uid = $studenttabres['uid'];
						
						if($resume == "0"){
							echo "
							<a href='faculty-studentresume.php?uid=$uid'>
							<div class='individuals' style='background-color:#8c8c8c;'>
