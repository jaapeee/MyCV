...
<html>
	<head>
		...
		<title>Student Resume (Skills)</title>
	...
	<body>
		...
		<div class="form">
		<form action="exec/student-resume-skills-add.php" method="post">
		<table border="0">
			<tr>
				<td width="50%" style="text-align:right;"><input style="width:60%;"type="text" id="fname" name="skill" placeholder="Skill: Good Listener"></td>
				<td width="50%" rowspan="2"><textarea style="height:80px; width:60%;"name="description" placeholder="TYPE HERE"></textarea></td>
			</tr>
			<tr>
				<td width="40%" style="text-align:right;">
					<select style="color: maroon;" name="skilltype">
			...
			<tr>
				<td width="40%" style="text-align:right;"><a href="student-resume.php"><input type="button" class="button1" value="Back"></a></td>
				<td><input type="submit" class="button2" value="Submit"></a></td>
		...
		<table border="0" cellpadding="0" cellspacing="5">
			<tr style="background-color:maroon; color:yellow;">
				<td style="padding-left:10px;" width="15%">Skill</td>
				<td style="padding-left:10px;" width="15%">Type</td>
				<td style="padding-left:10px;" width="65%">Description</td>
				<td style="padding-left:10px;" width="5%">Delete</td>
			</tr>
			<?
				$skillstablequery=mysql_query("SELECT * FROM skills WHERE uid='$uid' ORDER BY type");
				while($skilltable = mysql_fetch_array($skillstablequery)){
					$id = $skilltable['id'];
					$skill = $skilltable['skill'];
					$type = $skilltable['type'];
					...
					<tr class='trhover'>
						...
						<td>".$type."</td>
						<td>".$description."</td>
						<td><a href='exec/student-resume-skills-deleteskill.php?id=$id'><img></td>
					</tr>";
				}
			?>
